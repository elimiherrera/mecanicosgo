...
const PLANS = [
  {
    ...
    featured: false,
    features: [
      { label: 'Afinaciones menores', included: true },
      { label: 'Cambio de aceite (2 veces/año)', included: true },
      { label: 'Revisión de frenos', included: true },
      { label: 'Diagnóstico básico OBD', included: true },
      { label: 'Cambio de filtros de aire', included: true },
      { label: 'Afinaciones mayores', included: false },
      { label: 'Cambio de transmisión', included: false },
  ...
  },
  {
    ...
    featured: true,
    features: [
      { label: 'Afinaciones menores y mayores', included: true },
      { label: 'Cambio de aceite (4 veces/año)', included: true },
      { label: 'Revisión completa de frenos', included: true },
      { label: 'Diagnóstico OBD avanzado', included: true },
      { label: 'Cambio de filtros completo', included: true },
      { label: 'Revisión de código OBD', included: true },
      { label: 'Cambio de transmisión', included: false },
      { label: 'Soporte prioritario 24/7', included: false },
    ],
  },
  {
    ...
    features: [
      { label: 'Afinaciones menores y mayores', included: true },
      { label: 'Cambio de aceite ilimitado', included: true },
      { label: 'Revisión completa de frenos', included: true },
      { label: 'Diagnóstico OBD completo', included: true },
      { label: 'Cambio de filtros completo', included: true },
      { label: 'Revisión de código OBD', included: true },
      { label: 'Cambio de Mesa (Gasolina)', included: true },
...
const COMPARISON = [
  ...
  { feature: 'Cambios de aceite',         basico: '2/año',     intermedio: '4/año',     premium: 'Ilimitado' },
  { feature: 'Cambio de Mesa (Gasolina)', basico: false,       intermedio: false,       premium: true },
  { feature: 'Diagnóstico OBD',          basico: 'Básico',    intermedio: 'Avanzado',  premium: 'Completo' },
  { feature: 'Empaques de frenos',        basico: true,        intermedio: true,        premium: true },
  { feature: 'Empaques de motor',         basico: false,       intermedio: false,       premium: true },
  { feature: 'Revisión de código OBD',    basico: false,       intermedio: true,        premium: true },
];
// ────────────────────────────────────────────────────────────────────────────
